...
# Run example: sudo docker run --gpus device=0 -v /home/eldorado/datasets/DRealWorldSR/Train_x2/train_LR_bicubic_from_HR:/opt/bicubic -v /home/eldorado/datasets/DRealWorldSR/Train_x2/train_LR:/opt/train_LR -v /home/eldorado/dev/image_enhacement_autoencoders/autoencoder_x2_s/logs:/opt/logs -v /home/eldorado/dev/image_enhacement_autoencoders/autoencoder_x2_s/checkpoints:/opt/checkpoints --env TENSORBOARD_OUTPUT=/tmp/logs --env CHECKPOINTS_OUTPUT=/tmp/checkpoints --env MODEL=Autoencoder_x2_s --env X_ROOT=/opt/bicubic --env Y_ROOT=/opt/train_LR --env LEARNING_RATE=0.001 -it image_enhacement_autoencoder
